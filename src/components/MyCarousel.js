...
function MyCarousel() {
  return (
    <>
      ...
      <Container
        fluid
        className="carouselSection p-0 d-md-block d-none"
      >
      ...
      <Container
        fluid
        className="m-carouselSection p-0 d-md-none d-block"
      >
      ...
      <Container
        fluid
        className="m-sliderbar p-0 mt-3 mb-5 d-md-none d-block"
      >
